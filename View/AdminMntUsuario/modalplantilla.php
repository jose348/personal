<div id="modalplantilla" class="modal fade row " data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content bd-0">
            <div class="modal-header pd-y-20 pd-x-25">
                <h6 id="" class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Subir Planilla</h6>
