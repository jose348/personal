...
?>
  ...
  <head>
    ...
    ?>
    <title>Mantenimiento::Intructor</title>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">Mantenimiento del Instructor</span>
        </nav>
      </div><!-- br-pageheader -->
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <strong class="d-block d-sm-inline-block-force text text-primary">MANTENIMIENTO DEL INSTRUCTOR</strong>
              ...
              <table id="instructor_data" class="table display responsive nowrap">
                <thead>
                  <tr>
                    ...
                    <th class="wd-15p">A. Paterno</th>
                    <th class="wd-15p">A. Materno</th>
