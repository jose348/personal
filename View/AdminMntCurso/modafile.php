<div id="modalfile" class="modal fade row " data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-header pd-y-20 pd-x-25">
            ...
            <form method="post" id="detalle_form"> 
                ...
                <div class="modal-footer">
                    ...
                    <button name="action" onclick="guardarimg()" name="action" value="add" class="btn btn-outline-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"><i class="fa fa-check"></i> Guardar</button>
